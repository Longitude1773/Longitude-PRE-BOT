...
export function buildListingRow(input: JsonObject, flags: Record<string, string | boolean>) {
  ...
  return {
    ...
    Agent: getFirstString(input, ["Agent", "agent", "listingAgentName"]),
    "Listing Agent Name": getFirstString(input, ["Listing Agent Name", "listingAgentName"]),
    "Listing Agent Email": getFirstString(input, ["Listing Agent Email", "listingAgentEmail"]),
    "Listing Agent Phone": getFirstString(input, ["Listing Agent Phone", "listingAgentPhone"]),
    "Listing Brokerage": getFirstString(input, ["Listing Brokerage", "listingBrokerage"]),
